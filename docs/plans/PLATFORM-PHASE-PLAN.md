...
_Next step: Approve Phase A scope, then implement on branch `feat/auth-rbac-phase-a`. LangSmith tracing can be enabled in chat during Phase F; Phase H ships the admin UI._
