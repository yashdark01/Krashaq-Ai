...
export async function resendVerificationEmail(email: string) {
  ...
  await sendTransactionalEmail(normalized, mail.subject, mail.html, 'verify-email', mail.text);
...
export async function requestPasswordReset(email: string) {
  ...
  if (user) {
    ...
    await sendTransactionalEmail(normalized, mail.subject, mail.html, 'reset-password', mail.text);
  }
