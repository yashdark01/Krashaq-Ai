        ...
        <div className="krashaq-page-padding max-w-4xl mx-auto py-6 space-y-6">
          ...
          <Card className="border-primary/20 bg-primary/5">
            <CardContent className="pt-4 text-sm flex gap-3">
              ...
              <p>
                <strong>B2B2C model:</strong> Admin licenses you → you subscription-seat farmers.
                Each farmer needs an active plan to use chat, weather, and alerts.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm space-y-2">
              <p>
                • <strong>Trial</strong> — 14 days free (chat + weather)
              </p>
              <p>
                • <strong>Basic</strong> — ₹99 / 30 days
              </p>
              <p>
                • <strong>Standard</strong> — ₹249 / 90 days (+ alerts)
              </p>
              <p>
                • <strong>Premium</strong> — ₹799 / 365 days (full advisory)
              </p>
