...
export const api = {
  ...
  post: <T>(endpoint: string, body?: unknown, options?: ApiRequestOptions) => apiClient.post<T>(endpoint, body, options),
  put: <T>(endpoint: string, body?: unknown, options?: ApiRequestOptions) => apiClient.put<T>(endpoint, body, options),
  delete: <T>(endpoint: string, options?: ApiRequestOptions) => apiClient.delete<T>(endpoint, options),
  patch: <T>(endpoint: string, body?: unknown, options?: ApiRequestOptions) => apiClient.patch<T>(endpoint, body, options),
};
