...
import { createFarmerSubscription, getSubscriptionsByFarmerIds } from '@/lib/server/services/farmer-subscription-service';

function serializeFarmer(f: Record<string, unknown>, subscription?: Record<string, unknown> | null) {
  return {
    id: String(f._id),
