...
export const LLM_PROVIDERS: LLMProviderDefinition[] = [
  {
    ...
    models: [
      { id: 'llama-3.3-70b-versatile', label: 'Llama 3.3 70B', description: 'Best general purpose' },
      { id: 'llama-3.1-8b-instant', label: 'Llama 3.1 8B Instant', description: 'Fast & lightweight' },
  ...
  },
  {
    ...
    models: [
      { id: 'claude-3-5-sonnet-latest', label: 'Claude 3.5 Sonnet', description: 'Balanced quality' },
