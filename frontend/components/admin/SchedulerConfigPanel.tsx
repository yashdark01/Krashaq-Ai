              ...
              <div className="space-y-4">
                {editing === config.id ? (
                  <div className="space-y-4 border-t pt-4">
                    ...
                    {formData.schedule_type === "interval" && (
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">Message will be sent every X hours</p>
                      </div>
                    )}
                    ...
                    <div className="flex gap-2">
                      <Button onClick={() => updateConfig(config.id)}>
                        Save Changes
                      </Button>
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <p>Last run: {config.last_run ? new Date(config.last_run).toLocaleString() : "Never"}</p>
