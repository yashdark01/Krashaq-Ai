    ...
    return (
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: 'Active licenses', value: stats.licenses, icon: Shield, href: '/admin/suppliers' },
          { label: 'Farmers', value: stats.farmers, icon: Sprout, href: '/admin/suppliers' },
          { label: 'Sessions', value: stats.sessions, icon: MessageSquare, href: '/admin/analytics' },
    ...
    return (
      <div className="grid grid-cols-2 gap-3">
        <Link href="/supplier">
          <Card className="hover:bg-accent/50 transition-colors">
            <CardHeader className="pb-2 pt-4 px-4">
              <CardTitle className="text-xs font-medium text-muted-foreground">Supplier hub</CardTitle>
            </CardHeader>
            <CardContent className="px-4 pb-4">
    ...
    return (
      <Card>
        <CardContent className="pt-4 pb-4 px-4 text-sm text-muted-foreground">
          Welcome back, {user?.name}. Check weather below or ask Krashaq about crops, irrigation, and
          schemes.
        </CardContent>
      </Card>
    );
