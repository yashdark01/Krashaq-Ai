...
from app.conversation.services.llm_agent import LLMAgent
from app.weather.services.weather import get_weather, format_weather_for_farmer
from app.irrigation.services.irrigation_logic import get_irrigation_advice
from app.conversation.services.memory import cleanup_old_sessions, get_session_stats
from app.conversation.services.langchain_memory import langchain_memory_service
...
async def get_llm_providers():
    ...
    """
    from app.services.llm_provider import PROVIDER_CONFIGS, get_available_providers, DEFAULT_CHAIN
    from app.common.config import get_settings
